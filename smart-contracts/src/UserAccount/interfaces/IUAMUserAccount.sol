...
interface IUAMUserAccount {
    ...
    function receiveRepayInfo(address tonWallet, address tip3UserWallet, uint256 tokensForRepay, uint32 marketId, uint8 loanId, BorrowInfo borrowInfo) external view;
    ...
    function writeBorrowInformation(address tonWallet, address userTip3Wallet, uint256 tokensToBorrow, uint32 marketId) external;

    // Liquidation operation
    function markForLiquidation(address tonWallet) external;
